...
namespace Demo.KQL.FunctionsNet6
{
    public static class KustoAiFunction
    {
        ...
        public static async Task<IActionResult> Run(
            ...
            ILogger log)
        {
            var client = Kusto.Data.Net.Client.KustoClientFactory.CreateCslQueryProvider("https://ade.applicationinsights.io/subscriptions/5bb4a4b4-11df-4ed5-a790-cd6c34a98417/resourcegroups/kql-demo/providers/microsoft.insights/components/bicep-appi-2wej7bj;Fed=true;Initial Catalog=bicep-appi-2wej7bj");
